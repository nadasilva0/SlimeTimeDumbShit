...
execute positioned ~-1.5 ~-1.5 ~-1.5 as @e[tag=!has_jaws,type=!#slimelib:not_mob,dx=2,dy=2,dz=2] run function dumb:jawsofbabel/collide_super
...
execute if score .distance tf_rc matches ..30 positioned ^ ^ ^0.1 rotated ~2 ~ run function dumb:jawsofbabel/spin/raycast
