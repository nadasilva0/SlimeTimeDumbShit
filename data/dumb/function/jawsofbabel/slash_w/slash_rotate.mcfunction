function dumb:jawsofbabel/slash_w/start_raycast
...
execute if score @s loopCount matches 1.. run schedule function dumb:jawsofbabel/slash_w/slash_rotate_schedule 2t
