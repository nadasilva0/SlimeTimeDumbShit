...
execute as @e[tag=!raycasting,tag=!coin,tag=!hitbytau,type=!#slimelib:not_mob,dx=0] positioned ~-0.50 ~-0.50 ~-0.50 if entity @s[dx=0] positioned ~0.50 ~0.50 ~0.50 run function dumb:gauss/collide_charge3
execute as @e[tag=!raycasting,type=slime,tag=coin,dx=0] positioned ~-0.50 ~-0.50 ~-0.50 if entity @s[dx=0] positioned ~0.50 ~0.50 ~0.50 run function dumb:gauss/collide_coinnuke_big_start
...
particle trail{color:[1.000,1.000,1.000],target:[0,0,0],duration:1} ~ ~ ~ 0 0 0 1 0 force
...
execute unless score .pierces tf_rc matches ..0 if score .distance tf_rc matches ..500 positioned ^ ^ ^0.1 rotated ~ ~ run function dumb:gauss/raycast_charge3
