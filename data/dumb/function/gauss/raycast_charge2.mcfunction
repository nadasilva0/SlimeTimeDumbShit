...
execute as @e[tag=!raycasting,type=!#slimelib:not_mob,dx=0] positioned ~-0.50 ~-0.50 ~-0.50 if entity @s[dx=0] positioned ~0.50 ~0.50 ~0.50 run function dumb:gauss/collide_charge2
...
execute if score .distance tf_rc matches ..1000 positioned ^ ^ ^0.3 rotated ~ ~ if block ~ ~ ~ #slimelib:raycast_pass run function dumb:gauss/raycast_charge2
