...
execute as @e[tag=!raycasting,tag=!coin,tag=!hitbytau,type=!#slimelib:not_mob,dx=0] positioned ~-0.50 ~-0.50 ~-0.50 if entity @s[dx=0] positioned ~0.50 ~0.50 ~0.50 run function dumb:gauss/collide_charge1
...
#particle dust{color:[1.000,0.700,0.000],scale:0.8} ~ ~ ~ 0 0 0 0 1 force
particle trail{color:[1.000,1.000,0.600],target:[0,0,0],duration:1} ~ ~ ~ 0 0 0 1 0 force
...
execute unless score .pierces tf_rc matches ..0 if score .distance tf_rc matches ..500 positioned ^ ^ ^0.1 rotated ~ ~ run function dumb:gauss/raycast_charge1
