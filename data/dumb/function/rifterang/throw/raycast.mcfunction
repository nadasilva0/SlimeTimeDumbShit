...
execute as @e[tag=!raycasting,type=!#slimelib:not_mob,dx=0] positioned ~-0.50 ~-0.50 ~-0.50 if entity @s[dx=0] positioned ~0.50 ~0.50 ~0.50 run function dumb:rifterang/throw/collide_player
...
execute if score .distance tf_rc matches ..600 positioned ^ ^ ^0.49 rotated ~ ~ if block ~ ~ ~ #slimelib:raycast_pass run function dumb:rifterang/throw/raycast
