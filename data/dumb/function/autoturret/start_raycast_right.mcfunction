...
execute anchored eyes positioned ^0.35 ^0.2 ^0.2 facing entity @e[distance=..8,sort=nearest,type=!#slimelib:nottargetable,team=!Ikoss,limit=1] eyes run function dumb:autoturret/raycast
...
scoreboard players set @s turretbarrel 0
