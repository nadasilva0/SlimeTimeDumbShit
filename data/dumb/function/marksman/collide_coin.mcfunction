...
execute facing entity @e[tag=!marksman,tag=!coin,type=!#slimelib:not_mob,sort=nearest,distance=..15,limit=1] feet if block ~ ~ ~ #slimelib:raycast_pass run function dumb:marksman/start_raycast_coin
