...
execute as @e[tag=!raycasting,tag=!coin,type=!#slimelib:not_mob,dx=0] positioned ~-0.50 ~-0.50 ~-0.50 if entity @s[dx=0] positioned ~0.50 ~0.50 ~0.50 run function dumb:marksman/collide
execute as @e[tag=!raycasting,type=slime,tag=coin,dx=0] positioned ~-0.50 ~-0.50 ~-0.50 if entity @s[dx=0] positioned ~0.50 ~0.50 ~0.50 run function dumb:marksman/collide_coin

scoreboard players add .distance tf_rc 1

# Make raycast visible
particle dust{color:[0.000,0.000,0.000],scale:0.3} ~ ~ ~ 0 0 0 0 1 force
...
execute if score .distance tf_rc matches ..1000 positioned ^ ^ ^0.1 rotated ~ ~ if block ~ ~ ~ #slimelib:raycast_pass run function dumb:marksman/raycast
