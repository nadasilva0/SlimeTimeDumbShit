...
execute positioned ~-0.5 ~-0.5 ~-0.5 as @e[tag=!has_ragescythe,tag=!hitbyscythe,type=!#slimelib:not_mob,dx=1,dy=1,dz=1] run function dumb:ragescythe/slash_e/collide
...
execute if score .distance tf_rc matches ..30 positioned ^ ^ ^0.1 rotated ~-2 ~ run function dumb:ragescythe/slash_e/raycast
