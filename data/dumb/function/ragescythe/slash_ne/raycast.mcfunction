...
execute positioned ~-1 ~-1 ~-1 as @e[tag=!has_ragescythe,type=!#slimelib:not_mob,dx=1,dy=1,dz=1] run function dumb:ragescythe/slash_ne/collide
...
execute if score .distance tf_rc matches ..30 positioned ^ ^-0.025 ^0.1 rotated ~-2 ~ run function dumb:ragescythe/slash_ne/raycast
