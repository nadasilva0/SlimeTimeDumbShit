...
execute positioned ~ ~2 ~ run summon item_display ^ ^ ^2 {billboard:"vertical",item_display:"head",Tags:["wgorer_waypoint"],brightness:{sky:15,block:15},transformation:{left_rotation:[0f,0f,0f,1f],right_rotation:[0f,0f,0f,1f],translation:[0f,0f,0f],scale:[1f,0f,1f]},item:{id:"minecraft:paper",count:1,components:{"minecraft:item_model":"slimetime:choo_waypoint"}}}
