...
execute positioned ~-1 ~-1 ~-1 as @e[tag=!raycasting,tag=!glaiver,type=!#slimelib:not_mob,dx=1,dy=1,dz=1] run function dumb:crossfade2/collide
...
execute if score .distance tf_rc matches ..8 positioned ^ ^ ^1 rotated ~ ~ run function dumb:crossfade2/raycast
