...
execute as @e[tag=!raycasting,type=!#slimelib:not_mob,dx=0] positioned ~-0.50 ~-0.50 ~-0.50 if entity @s[dx=0] positioned ~0.50 ~0.50 ~0.50 run function dumb:raycast_example/collide

scoreboard players add .distance tf_rc 1

# Make raycast visible
particle dust{color:[1.000,0.000,0.000],scale:1} ~ ~ ~ 0 0 0 1 1 force
...
execute if score .distance tf_rc matches ..1000 positioned ^ ^ ^0.1 rotated ~ ~ if block ~ ~ ~ #slimelib:raycast_pass run function dumb:raycast_example/raycast
