...
execute as @e[tag=!raycasting,type=!#slimelib:not_mob,dx=0] positioned ~-0.50 ~-0.50 ~-0.50 if entity @s[dx=0] positioned ~0.50 ~0.50 ~0.50 run function dumb:meteor/crossbow/collide

scoreboard players add .distance tf_rc 1

# Make raycast visible
particle dust{color:[0.000,1.000,0.500],scale:1} ~ ~ ~ 0 0 0 0 0 force
...
execute if score .distance tf_rc matches ..400 positioned ^ ^ ^0.1 rotated ~ ~ if block ~ ~ ~ #slimelib:raycast_pass run function dumb:meteor/crossbow/raycast
