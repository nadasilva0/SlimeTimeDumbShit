...
execute as @e[tag=!raycasting,type=!#slimelib:not_mob,dx=0] positioned ~-0.05 ~-0.05 ~-0.05 if entity @s[dx=0] positioned ~0.05 ~0.05 ~0.05 run function dumb:guns/rifle/collide
...
execute if score .distance tf_rc matches ..1600 positioned ^ ^ ^0.1 rotated ~ ~ if block ~ ~ ~ #slimelib:raycast_pass run function dumb:guns/rifle/raycast
