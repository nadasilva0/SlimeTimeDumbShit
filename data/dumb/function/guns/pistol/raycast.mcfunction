...
execute as @e[tag=!raycasting,type=!#slimelib:not_mob,dx=0] positioned ~-0.05 ~-0.05 ~-0.05 if entity @s[dx=0] positioned ~0.05 ~0.05 ~0.05 run function dumb:guns/pistol/collide
...
execute if score .distance tf_rc matches ..150 positioned ^ ^ ^0.1 rotated ~ ~ if block ~ ~ ~ #slimelib:raycast_pass run function dumb:guns/pistol/raycast
