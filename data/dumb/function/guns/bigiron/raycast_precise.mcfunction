...
execute as @e[tag=!raycasting,type=!#slimelib:not_mob,dx=0] positioned ~-0.05 ~-0.05 ~-0.05 if entity @s[dx=0] positioned ~0.05 ~0.05 ~0.05 run function dumb:guns/bigiron/collide_precise
...
particle minecraft:dust{color:[0.000,0.000,0.000],scale:0.2} ~ ~ ~ 0 0 0 0 1 force
...
execute if score .distance tf_rc matches ..1000 positioned ^ ^ ^0.1 rotated ~ ~ if block ~ ~ ~ #slimelib:raycast_pass run function dumb:guns/bigiron/raycast_precise
