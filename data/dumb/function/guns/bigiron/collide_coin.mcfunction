...
execute facing entity @n[tag=!raycasting,tag=!coin,type=!#slimelib:not_mob,distance=..15,limit=1] feet if block ~ ~ ~ #slimelib:raycast_pass run function dumb:guns/bigiron/start_raycast_coin
